 ...
 *
 * @domid - id of the domain you sharing gref with
 * @gfn - guest frame number of page, where grant will be located
 * @readonly - permit readonly access to shared grant
 ...
 *
 * @gref - grant reference that need to be closed
 ...
 *
 * @map - double pointer to memory, where grant will be allocated
 * @readonly - permit readonly access to allocated grant
 ...
 *
 * @page_addr - pointer to start address of used page.
 */
 ...
 *
 * @map_ops - array of prepared gnttab_map_grant_ref's for mapping
 * @count - number of grefs in map_ops array
 ...
 *
 * @unmap_ops - array of prepared gnttab_map_grant_ref's for unmapping
 * @count - number of grefs in unmap_ops array
 ...
 *
 * @status - negative GNTST_* code, that needs to be converted
